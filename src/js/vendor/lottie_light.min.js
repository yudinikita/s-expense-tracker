                          ...
                          if (
                            ...
                            for (r = p.length, a = 0; a < r; a += 1)
                              if (p[a].pt.k.i) c(p[a].pt.k);
                                ...
                                for (h = p[a].pt.k.length, n = 0; n < h; n += 1)
                          ...
                          if (t.chars && !h(o, t.v)) {
                            ...
                            for (e = 0; e < n; e += 1)
                              if (t.chars[e].data && t.chars[e].data.shapes)
                                for (
                                  i = (r = t.chars[e].data.shapes[0].it).length,
                                    s = 0;
                                  s < i;
                                  s += 1
                                )
    ...
    var O = (function () {
      ...
      B = (function () {
        ...
        function d(t, e) {
          ...
          if (a.to) {
            n.bezierData ||
              (n.bezierData = dt.buildBezierData(a.s, r.s || a.e, a.to, a.ti));
            var F = n.bezierData;
            if (C <= t || t < x) {
              ...
              n.__fnct
                ? (d = n.__fnct)
                : ((d = H.getBezierEasing(a.o.x, a.o.y, a.i.x, a.i.y, a.n).get),
                  (n.__fnct = d)),
                (l = d((t - x) / (C - x)));
              var M,
                E = F.segmentLength * l,
                          ...
                          ? (n.__fnct || (n.__fnct = []),
                            n.__fnct[c]
                              ...
                              : ((L =
                                ...
                                (V = void 0 === a.o.y[c] ? a.o.y[0] : a.o.y[c]),
                                (R = void 0 === a.i.x[c] ? a.i.x[0] : a.i.x[c]),
                                (z = void 0 === a.i.y[c] ? a.i.y[0] : a.i.y[c]),
              ...
              if (C[a].n) {
                ...
                for (M = 0; M < E; M += 1)
                  (T = A[M].a).t.propType &&
                    ...
                    (L = A[M].s.getMult(C[a].anIndexes[M], P.a[M].s.totalChars))
                      .length
                      ? (st += T.t.v * L[0] * at)
                      : (st += T.t.v * L * at));
                nt = !1;
      ...
      function s(t, e, s) {
        ...
        for (o = 0; o < c; o += 1) {
          ...
          if (((a = (l = e.sh.paths)._length), n)) {
            for (r = "", i = 0; i < a; i += 1)
              (h = l.shapes[i]) && h._length && (r += ht(h, h._length, h.c, p));
            e.caches[o] = r;
          } else r = e.caches[o];
        ...
        this.imagePreloader.setCacheType(e, this.renderer.globalData.defs),
          ...
          t.animationData
            ...
            : t.path &&
              ...
              N.loadAnimation(t.path, this.configAnimation, this.onSetupError));
      }),
        ...
        if (this._cbs && this._cbs[t])
          switch (t) {
            ...
            case "complete":
              ...
              break;
            case "segmentStart":
              this.triggerEvent(t, new u(t, this.firstFrame, this.totalFrames));
              break;
            case "destroy":
